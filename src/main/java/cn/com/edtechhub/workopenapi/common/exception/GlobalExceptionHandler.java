...
public class GlobalExceptionHandler {
    ...
    public BaseResponse<String> exceptionHandler(Exception e) {
        ...
        return ResultUtils.error(ErrorCode.SYSTEM_ERROR, "请联系管理员 89838804@qq.com");
    }
    ...
    public BaseResponse<?> businessExceptionHandler(BusinessException e) {
        ...
        return ResultUtils.error(e.getErrorCode(), e.exceptionMessage);
    }
    ...
    public BaseResponse<?> notLoginExceptionHandler() {
        ...
        return ResultUtils.error(ErrorCode.NO_LOGIN_ERROR, "请先进行登录");
    }
    ...
    public BaseResponse<?> notRoleExceptionHandler() {
        ...
        return ResultUtils.error(ErrorCode.NO_ROLE_ERROR, "用户当前角色不允许使用该功能");
    }
    ...
    public BaseResponse<?> notPermissionExceptionHandler() {
        ...
        return ResultUtils.error(ErrorCode.NO_AUTH_ERROR, "用户当前权限不允许使用该功能, 请申请权限");
    }
    ...
    public BaseResponse<?> disableServiceExceptionHandler() {
        ...
        return ResultUtils.error(ErrorCode.USER_DISABLE_ERROR, "当前用户因为违规被封禁");
    }
